...
export const POST = async (NextRequest) => {
    ...
    try {
        ...
        const { imageUrl, title, description, category, meta, keywords, type, author, url } = await NextRequest.json()
        const project = await Project({ imageUrl, title, description, category, meta, keywords, type, author, userId, url }).save()
